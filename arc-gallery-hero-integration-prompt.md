# ArcGalleryHero — Component Integration Prompt

> เก็บไว้สำหรับเอาไปถาม/รันในโปรเจกต์ React + Tailwind + shadcn (เช่นบน 21st.dev หรือ AI assistant ตัวอื่น)
> โปรเจกต์ dnd-dm-agent ปัจจุบันเป็น vanilla HTML/JS จึงไม่เข้ากับ task นี้โดยตรง — ใช้ที่อื่น
